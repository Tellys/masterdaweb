            ...
            <section>
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        <h1 class="text-center">Editar os Produto da Base</h1>
                        <p class="text-center">Modifique os dados dos Produtos em nossa base de dados.</p>
                            ...
                            <form @submit.prevent='editProduct'>
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" id="name" class="form-control form-control-lg"
                                        v-model="data.name" required autofocus />
                                ...
                                <div class="form-outline mb-4">
                                    <textarea id="detail" class="form-control form-control-lg"
                                     v-model="data.detail" required></textarea>
